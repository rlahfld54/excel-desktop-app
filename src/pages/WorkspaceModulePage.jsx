...
const moduleConfigs = {
  recentTasks: {
    ...
    rows: [
      ...
      ['14:38', '거래처 코드 매핑', 'supplier_codes.csv', '확인 필요', '박지훈'],
      ['13:12', '중복 행 검사', 'monthly_sales.xlsx', '성공', '이서연'],
      ['11:47', '보고서 생성', 'may_report.xlsx', '대기', '최현우'],
    ],
    sideTitle: '다음 작업',
    sideItems: ['확인 필요 항목 검토', '보고서 초안 승인', '예약 작업 실행'],
  },
  fileManager: {
    title: '파일 관리',
  ...
  taskHistory: {
    ...
    rows: [
      ...
      ['JOB-5820', '박지훈', '코드 매핑', '14:38', '확인 필요'],
      ['JOB-5819', '이서연', '중복 검사', '13:12', '성공'],
      ['JOB-5818', '시스템', '자동 백업', '12:00', '성공'],
    ],
    sideTitle: '관리 작업',
    sideItems: ['실패 작업 재시도', '사용자별 필터', '감사 자료 다운로드', '오래된 이력 보관'],
  },
  systemStatus: {
    title: '시스템 상태',
