      ...
      >
        ...
        <div className="space-y-8">
          <div>
            ...
            <ul className="mt-3">
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 bg-linear-to-r ${pathname === "/" ? 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' : ''}`}>
                <NavLink
                  end
                  to="/"
                  className={({ isActive }) =>
                      ...
                      <React.Fragment>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg className={`shrink-0 fill-current ${active ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
