...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-accent-50 hover:text-accent-700 dark:hover:bg-accent-500/10 dark:hover:text-accent-300 rounded-full"
